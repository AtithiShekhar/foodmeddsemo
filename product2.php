                    ...
                    <div class="card card-info">
                        ...
                        document.addEventListener('DOMContentLoaded', function() {
                            ...
                            if (savedData) {
                                ...
                                // Restore active tab
                                if (data['activeTab']) {
                                    const tab = document.querySelector(`.nav-tabs a[href="${data['activeTab']}"]`);
                                    if (tab) tab.click();
                                }
                                
                                // Show restored notification
                                const toast = document.createElement('div');
                                toast.style = 'position:fixed; bottom:20px; right:20px; padding:10px; background:#4CAF50; color:white; border-radius:4px; z-index:9999;';
                                toast.textContent = '✓ Draft restored';
                                document.body.appendChild(toast);
                                setTimeout(() => toast.remove(), 3000);
                            }

                            // 2. AUTO-SAVE on every change (debounced)
                            let saveTimeout;
                            function saveFormState() {
                                ...
                                form.querySelectorAll('input, textarea, select').forEach(field => {
                                    if (field.name) {
                                        formData[field.name] = field.type === 'checkbox' || field.type === 'radio' 
                                            ? field.checked 
                                            : field.value;
                                    }
                                });
                                ...
                                if (activeTab) {
                                    formData['activeTab'] = activeTab.getAttribute('href');
                                }
                            ...
                            document.querySelectorAll('.nav-tabs a').forEach(tab => {
                                tab.addEventListener('click', saveFormState);
                            });
                                    ...
                                    setup: function(editor) {
                                        ...
                                        if (savedData) {
                                            editor.on('init', function() {
                                                const data = JSON.parse(savedData);
                                                if (data[editor.id]) {
                                                    editor.setContent(data[editor.id]);
                                                }
                                            });
                                        }
                                    }
                            ...
                            // Initialize Bootstrap Switch if present
                            if (typeof $().bootstrapSwitch !== 'undefined') {
                                $('[data-bootstrap-switch]').bootstrapSwitch();
                            }
                        });
                        </script>
                        <!-- ===== END AUTO-SAVE SCRIPT ===== -->
                            ...
                            <div class="card-body">
                                ...
                                <ul class="nav nav-tabs" id="productFormTabs" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="shipping-tab" data-toggle="tab" href="#shipping" role="tab" aria-controls="shipping" aria-selected="false">Shipping & Tax</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <div class="tab-pane fade show active" id="basic" role="tabpanel" aria-labelledby="basic-tab">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <?php if (isset($payment_method['cod_method']) && $payment_method['cod_method'] == 1) { ?>
                                                <div class="col-md-3 cod_allowed <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                            ...
                                            <?php }
                                            ?>
                                            <div class="col-md-3 is_returnable <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                            ...
                                            <div class="col-md-3 is_cancelable <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                        ...
                                        <div class="form-group row <?= (isset($product_details[0]['is_cancelable']) && $product_details[0]['is_cancelable'] == 1) ? '' : 'collapse' ?>" id='cancelable_till'>
                                            <div class="col-md-12">
                                        ...
                                        <div class="form-group row is_attachment_required <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                            <div class="col-md-12 is_attachment_required d-flex justify-content-between">
                            ...
                            <div id="product_category_tree_view_html" class='category-tree-container'></div>
                                    ...
                                    <div class="tab-pane fade" id="shipping" role="tabpanel" aria-labelledby="shipping-tab">
                                        ...
                                        <div class="form-group col-md-12 deliverable_type">
                                        ...
                                        <?php
$pickup_location = isset($product_details[0]['pickup_location']) ? $product_details[0]['pickup_location'] : "";
$is_digital_product = isset($product_details[0]['type']) && $product_details[0]['type'] === 'digital_product';
?>

<div class="row mt-3 pickup_locations <?= $is_digital_product ? 'd-none' : '' ?>">
    <div class="col-md-8 standdard_shipping">
        <label for="pickup_location" class="col-form-label">
            For Standard Shipping <span class="text-danger text-sm">*</span>
        </label>
        ...
        <select class="form-control shiprocket_type" name="pickup_location" id="pickup_location">
            ...
            if (!empty($shipping_data)) {
                foreach ($shipping_data as $row) {
                    $selected = ($row['pickup_location'] == $pickup_location) ? 'selected' : '';
                    ?>
                    <option value="<?= $row['pickup_location'] ?>" <?= $selected ?>>
                        <?= $row['pickup_location'] ?>
                    </option>
                <?php }
            } else { ?>
                <option disabled>No pickup locations available</option>
            <?php } ?>
        </select>
    </div>
</div>
                                    ...
                                    <div class="tab-pane fade" id="inventory" role="tabpanel" aria-labelledby="inventory-tab">
                                        <?php if (isset($product_details)) { ?>
                                            <div id="product-general-settings">
                                                <?php if ($product_details[0]['type'] == "simple_product" || $product_details[0]['type'] == "digital_product") { ?>
                                                    ...
                                                    <div class="form-group simple-product-level-stock-management <?= isset($HideStatus) ? $HideStatus : '' ?>">
                                                ...
                                                <div class="row mt-4 col-md-12 ">
                                                    <nav class="w-100">
                                                        <div class="nav nav-tabs" id="product-tab" role="tablist"> 
                                                            ...
                                                            <a class="nav-item nav-link disabled product-attributes" id="tab-for-attributes" data-toggle="tab" href="#product-attributes" role="tab" aria-controls="product-attributes" aria-selected="false"></a> 
                                    ...
                                    <div class="tab-pane fade" id="seo" role="tabpanel" aria-labelledby="seo-tab">
                                        ...
                                        <div class="d-flex bg-light">
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <input class='form-control' id='seo_meta_keywords' placeholder="SEO Meta Keywords" name="seo_meta_keywords" value="<?= isset($product_details[0]['seo_meta_keywords']) ? output_escaping($product_details[0]['seo_meta_keywords']) : "" ?>" />
                                            </div>
                                        </div>
                                        <div class="d-flex bg-light">
                                            <div class="form-group col-sm-6">
                                    ...
                                    <div class="tab-pane fade" id="description" role="tabpanel" aria-labelledby="description-tab">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <label for="tags">Addon Product</label>
                                                <select placeholder="Select Products" name="addon_product[]" id="Addon_Product" multiple>
                                                    <?php 
                                                        $selected_values = isset($product_details[0]['addon_product']) ? explode(",",$product_details[0]['addon_product']) : [];
                                                        foreach($addon_products as $addonProduct) :
                                                            $selected = '';
                                                            foreach ($selected_values as $selected_value) {
                                                             if ($addonProduct['id'] == $selected_value) {
                                                                $selected = 'selected';
                                                               break;
                                                               }
                                                        }
                                                        $value = $addonProduct['name'].' Price : '.$addonProduct['price'];
                                                    ?>
                                                    <option value="<?php echo $addonProduct['id'] ?>" <?php echo $selected ?>><p><?php echo $value; ?></p></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
