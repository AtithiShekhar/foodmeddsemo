                                ...
                                <div class="form-group row">
                                    <div class="col-md-8">
                                        <div class="row col mt-3">
                                            ...
                                            <div class="col-md-4 indicator <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>" hidden>
                                                                ...
                                                                <div id='product-general-settings'>
                                                                    ...
                                                                    if ($product_details[0]['type'] == "simple_product" || $product_details[0]['type'] == "digital_product") {
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <input type="text" name="simple_price" class="form-control stock-simple-mustfill-field price" value="<?= $product_variants[0]['price'] ?>" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="type" class="col-md-2">Special Price:</label>
                                                                            <div class="col-md-12">
                                                                                <input type="text" name="simple_special_price" class="form-control discounted_price" value="<?= $product_variants[0]['special_price'] ?>" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                                                                            </div>
                                                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <label for="tags">Addon Product</label>
                                                 <select placeholder="Select Products" name="addon_product[]" id="Addon_Product"  multiple>
                                                    ...
                                                    <?php 
                                                        $selected_values = explode(",",$product_details[0]['addon_product']);
                                                                            ...
                                                                            <div id="product-general-settings">
                                                                                <div id="general_price_section" class="collapse">
                                                                                    <div class="form-group">
                                                                                        <label for="type" class="col-md-2">Price:</label>
                                                                                        <div class="col-md-12">
                                                                                            <input type="text" name="simple_price" class="form-control stock-simple-mustfill-field price" min='1' oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="form-group">
                                                                                        <label for="type" class="col-md-2">Special Price:</label>
                                                                                        <div class="col-md-12">
                                                                                            <input type="text" name="simple_special_price" class="form-control discounted_price" min='0' oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                                                                                        </div>
                                                                                    </div>
                                                 ...
                                                 <select placeholder="Select Products" name="addon_product[]"  id="Addon_Product" multiple>
                                                    ...
                                                    <?php 
                                                        foreach($addon_products as $addonProduct) :
                                                            ...
                                                            $value = $addonProduct['name'].' Price : '.$addonProduct['price'];
                                                    ?>
                                                            <option value="<?php echo $addonProduct['id'] ?>" ><p><?php echo $value; ?></p></option>
                                                    <?php 
